...
![Example of a completed application.](./src/assets/example.png)
...
Your instructor set up the following [API](https://github.com/Angiepmunoz/resource-veterinarian-api) and give you the URL where to send your requests. 
